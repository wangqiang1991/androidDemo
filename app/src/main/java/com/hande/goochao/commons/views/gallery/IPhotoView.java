...
public interface IPhotoView {
    ...
    /**
     * 放大或移动photo后回调
     * @param onPhotoViewChangeListener
     */
    void setOnPhotoViewChangeListener(OnPhotoViewChangeListener onPhotoViewChangeListener);
    ...
    /**
     * 是否第一次默认放大的时候禁止拖拽移动内容
     * @param firstZoomDisableDrag
     */
    void setFirstZoomDisableDrag(boolean firstZoomDisableDrag);
}
