 ...
 */
public class GCBallPulseView extends View {
    ...
    public GCBallPulseView(Context context) {
        this(context, null);
    }

    public GCBallPulseView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GCBallPulseView(Context context, AttributeSet attrs, int defStyleAttr) {
